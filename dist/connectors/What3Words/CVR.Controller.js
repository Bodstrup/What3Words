...
class locationClassWords {
    constructor(inputData, inputResult) {
        ...
        this.locationEntity.setProperty('Longitude', inputData.coordinates.lng);
        this.locationEntity.setProperty('Description', inputData.nearestPlace);
        this.locationEntity.setProperty('Coordinates', { type: 'Point', coordinates: [+`${inputData.coordinates.lng}`, `${inputData.coordinates.lat}`] });
        console.log(inputData.coordinates.lat);
    }
    getResult() {
        return this.outputResult;
    }
...
//# sourceMappingURL=CVR.controller.js.map